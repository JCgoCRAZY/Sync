(() => {
  ...
  window.addEventListener('studyhub-cloud-status',event=>{
    ...
    else if(s.phase==='offline'){statusEl.textContent='Saved locally • offline';}
    else if(s.phase==='syncing'||s.phase==='pending'){statusEl.textContent='Saved locally • cloud syncing…';}
  });
