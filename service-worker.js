...
const CACHE = "ushub-2026-09-10-navigation-v13";
const CORE = [
  "./",
  "index.html",
  "styles.css",
...
const NETWORK_FIRST =
  /\/(?:index\.html|app\.js|app_fixes\.js|keyboard_navigation_fix\.js|deployment_version\.js|cloud_sync\.js|styles\.css|service-worker\.js|editor\/editor\.html|editor\/browser_editor_bridge\.js)(?:\?.*)?$/;
