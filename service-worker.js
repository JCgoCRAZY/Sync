'use strict';
const CACHE='ushub-2026-09-10-schedule-grading-fix-v9';
const CORE=[
  './','index.html','styles.css','app.js','app_fixes.js','cloud_sync.js','manifest.webmanifest','assets/icon.svg','assets/icon-180.png','assets/icon-192.png','assets/icon-512.png',
...
const NETWORK_FIRST=/\/(?:index\.html|app\.js|app_fixes\.js|cloud_sync\.js|styles\.css|service-worker\.js|editor\/editor\.html|editor\/browser_editor_bridge\.js)(?:\?.*)?$/;
